...
/**
 * Tests for <code>jblob.util.ByteBlob</code> which are constructed from
...
public class ByteBlobDiffTests {
	...
	public void test_08() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) '_');
		Blob v3 = v2.writeBytes(7, (byte) 'W', (byte) 'O');
		assertArrayEquals("HEL_lo World".getBytes(),v2.readAll());
		assertArrayEquals("HEL_lo WOrld".getBytes(),v3.readAll());
		assertTrue((v3 instanceof Blob.Diff) && ((Blob.Diff)v3).parent() == v1);
	}
	...
	public void test_09() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E');
		Blob v3 = v2.writeBytes(5, (byte) 'W', (byte) 'O');
	...
	public void test_10() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(6, 2, (byte) 'W', (byte) 'O', (byte) '_');
		Blob v3 = v2.writeBytes(1, (byte) 'E', (byte) 'L');
	...
	public void test_11() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(6, 2, (byte) 'W');
		Blob v3 = v2.writeBytes(1, (byte) 'E', (byte) 'L');
	...
	public void test_12() {
		...
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) '_');
		Blob v3 = v2.writeBytes(7, (byte) 'W', (byte) 'O');
		Blob v4 = v3.writeBytes(5, (byte) '0');
		assertArrayEquals("HEL_lo World".getBytes(),v2.readAll());
		assertArrayEquals("HEL_lo WOrld".getBytes(),v3.readAll());
		assertArrayEquals("HEL_l0 WOrld".getBytes(),v4.readAll());
		assertTrue((v4 instanceof Blob.Diff) && ((Blob.Diff)v4).parent() == v1);
	}
	...
	public void test_13() {
		...
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) '_');
		Blob v3 = v2.writeBytes(7, (byte) 'W', (byte) 'O');
		Blob v4 = v3.writeBytes(10, (byte) '1');
		assertArrayEquals("HEL_lo World".getBytes(),v2.readAll());
		assertArrayEquals("HEL_lo WOrld".getBytes(),v3.readAll());
	...
	public void test_14() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(6, 3, (byte) 'W', (byte) 'O', (byte) 'R', (byte) 'L');
		Blob v3 = v2.writeBytes(4, (byte) '0', (byte) '_');
		assertArrayEquals("Hello WORLld".getBytes(),v2.readAll());
		assertArrayEquals("Hell0_WORLld".getBytes(),v3.readAll());
		assertTrue((v3 instanceof Blob.Diff) && ((Blob.Diff) v3).parent() == v1);
		assertTrue((v3 instanceof Blob.Diff) && ((Blob.Diff) v3).count() == 1);
	}
	...
	public void test_15() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(6, 3, (byte) 'W', (byte) 'O');
		Blob v3 = v2.writeBytes(4, (byte) '0', (byte) '_');
	...
	public void test_16() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 3, (byte) 'E', (byte) 'L', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(5, (byte) '0', (byte) '_');
	...
	public void test_17() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 3, (byte) 'E', (byte) 'L');
		Blob v3 = v2.writeBytes(3, (byte) '0', (byte) '_');
		assertArrayEquals("HELo World".getBytes(),v2.readAll());
	...
	public void test_19() {
		...
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 3, (byte) 'E', (byte) 'L');
		Blob v3 = v2.writeBytes(4, (byte) '_');
		Blob v4 = v3.writeBytes(3, (byte) '0');
		assertArrayEquals("HELo World".getBytes(),v2.readAll());
	...
	public void test_20() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.writeBytes(1, (byte) 'E', (byte) 'L', (byte) 'L', (byte) 'O');
		Blob v3 = v2.writeBytes(1, (byte) '_', (byte) '1', (byte) '1', (byte) '0');
	...
	public void test_21() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.writeBytes(2, (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(1, (byte) '_', (byte) '1', (byte) '1', (byte) '0');
		assertArrayEquals("HeLLo World".getBytes(),v2.readAll());
		assertArrayEquals("H_110 World".getBytes(),v3.readAll());
		assertTrue((v3 instanceof Blob.Diff) && ((Blob.Diff) v3).parent() == v1);
	...
	public void test_22() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.writeBytes(1, (byte) 'E', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(1, (byte) '_', (byte) '1', (byte) '1', (byte) '0');
		assertArrayEquals("HELLo World".getBytes(),v2.readAll());
		assertArrayEquals("H_110 World".getBytes(),v3.readAll());
		assertTrue((v3 instanceof Blob.Diff) && ((Blob.Diff) v3).parent() == v1);
	...
	public void test_23() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.writeBytes(2, (byte) 'L', (byte) 'L', (byte) 'O');
		Blob v3 = v2.writeBytes(1, (byte) '_', (byte) '1', (byte) '1', (byte) '0');
		assertArrayEquals("HeLLO World".getBytes(),v2.readAll());
		assertArrayEquals("H_110 World".getBytes(),v3.readAll());
		assertTrue((v3 instanceof Blob.Diff) && ((Blob.Diff) v3).parent() == v1);
	...
	public void test_24() {
		...
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.writeBytes(1, (byte) 'E', (byte) 'L', (byte) 'L', (byte) 'O');
		Blob v3 = v2.writeBytes(2, (byte) '_', (byte) '1');
		assertArrayEquals("HELLO World".getBytes(),v2.readAll());
	...
	public void test_25() {
		...
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.writeBytes(1, (byte) 'E', (byte) 'L', (byte) 'L', (byte) 'O');
		Blob v3 = v2.writeBytes(1, (byte) '_', (byte) '1');
		assertArrayEquals("HELLO World".getBytes(),v2.readAll());
	...
	public void test_26() {
		...
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.writeBytes(1, (byte) 'E', (byte) 'L', (byte) 'L', (byte) 'O');
		Blob v3 = v2.writeBytes(3, (byte) '1', (byte) '0');
		assertArrayEquals("HELLO World".getBytes(),v2.readAll());
	...
	public void test_27() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(2, (byte) '1', (byte) '1', (byte) '1');
		assertArrayEquals("HELLlo World".getBytes(),v2.readAll());
	...
	public void test_28() {
		...
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 3, (byte) 'E', (byte) 'L');
		Blob v3 = v2.writeBytes(2, (byte) '1', (byte) '0');
		assertArrayEquals("HELo World".getBytes(),v2.readAll());
	...
	public void test_29() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(2, 2, (byte) 'L', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(1, (byte) '_', (byte) '1', (byte) '1');
		assertArrayEquals("HeLLLo World".getBytes(),v2.readAll());
	...
	public void test_30() {
		...
		byte[] bs1 = "Hello World".getBytes();
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(2, 3, (byte) 'L', (byte) 'O');
		Blob v3 = v2.writeBytes(1, (byte) '_', (byte) '1');
		assertArrayEquals("HeLO World".getBytes(),v2.readAll());
	...
	public void test_31() {
		...
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(5, (byte) '0');
		Blob v4 = v3.writeBytes(1, (byte) '_',(byte) '1',(byte) '1',(byte) '1',(byte) '0');
		assertArrayEquals("HELLlo World".getBytes(),v2.readAll());
	...
	public void test_32() {
		...
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(5, (byte) 'O');
		Blob v4 = v3.writeBytes(0, (byte) '#',(byte) '_',(byte) '1',(byte) '1',(byte) '1',(byte) '0',(byte) '_');
		assertArrayEquals("HELLlo World".getBytes(),v2.readAll());
	...
	public void test_33() {
		...
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(5, (byte) 'O');
		Blob v4 = v3.writeBytes(2, (byte) '1',(byte) '1',(byte) '1',(byte) '0');
		assertArrayEquals("HELLlo World".getBytes(),v2.readAll());
		assertArrayEquals("HELLlO World".getBytes(),v3.readAll());
	...
	public void test_34() {
		...
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(5, (byte) 'O');
		Blob v4 = v3.writeBytes(2, (byte) '1',(byte) '1',(byte) '1',(byte) '0',(byte) '_');
		assertArrayEquals("HELLlo World".getBytes(),v2.readAll());
		assertArrayEquals("HELLlO World".getBytes(),v3.readAll());
	...
	public void test_35() {
		...
		Blob v1 = new ByteBlob(bs1);
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(5, (byte) 'O', (byte) '_');
		Blob v4 = v3.writeBytes(1, (byte) '_',(byte) '1',(byte) '1',(byte) '1',(byte) '0');
		assertArrayEquals("HELLlo World".getBytes(),v2.readAll());
		assertArrayEquals("HELLlO_World".getBytes(),v3.readAll());
	...
	public void test_36() {
		...
		Blob v2 = v1.replaceBytes(1, 2, (byte) 'E', (byte) 'L', (byte) 'L');
		Blob v3 = v2.writeBytes(5, (byte) 'O', (byte) '_');
		Blob v4 = v3.writeBytes(0, (byte) '#',(byte) '_',(byte) '1',(byte) '1',(byte) '1',(byte) '0');
		assertArrayEquals("HELLlo World".getBytes(),v2.readAll());
		assertArrayEquals("HELLlO_World".getBytes(),v3.readAll());
		assertArrayEquals("#_1110_World".getBytes(),v4.readAll());
		assertTrue((v4 instanceof Blob.Diff) && ((Blob.Diff) v4).parent() == v1);
	...
	private static void checkMutants(byte[] source, byte[] target, int n) {
		Blob[] mutants = new Blob[] { new ByteBlob(source) };
		//
		for (int i = 0; i != n; ++i) {
	...
	private static Blob[] mutate(byte[] target, Blob[] blobs) {
		...
		return tmp.toArray(new Blob[tmp.size()]);
	}
	...
	private static void check(String before, String... replacements) {
		...
		for (String after : permute(before, replacements)) {
			...
			ByteBlob.Replacement[] rs = ByteBlob.diff(before.getBytes(), after.getBytes());
			Blob.Diff diff = new ByteBlob.Diff(new ByteBlob(before.getBytes()), rs);
